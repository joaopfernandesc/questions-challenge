...
ActiveRecord::Schema.define(version: 2020_07_31_010043) do

  create_table "question_accesses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.datetime "date"
